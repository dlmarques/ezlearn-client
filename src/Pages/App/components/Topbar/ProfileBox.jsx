  ...
  return (
    ...
    <Grid.Container>
        <Row css={{display: "flex", justifyContent: "center", padding: "0"}}>
            <Text css={{color: "#00ADB5", fontSize: "1.5em" ,padding: "0", paddingTop: "10px"}}>Welcome {currentUser && username}</Text>
        </Row>
        <Row>
            <Text css={{color: "#eeeeee", display: "flex", alignItems: "center", gap:"5px", fontSize: "20px", paddingLeft: "10px", paddingBottom: "10px", paddingTop: "10px", cursor: "pointer", transition: "all .3s ease" ,'&:hover':{
                color: "#eeeeeec9"
            }}} >
                <FiUser />
                Profile</Text>
